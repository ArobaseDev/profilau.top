 ...
 */
final class Version20241002085430 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE job_offer (id INT AUTO_INCREMENT NOT NULL, app_user_id INT NOT NULL, title VARCHAR(80) NOT NULL, company VARCHAR(80) NOT NULL, link VARCHAR(255) DEFAULT NULL, location VARCHAR(255) DEFAULT NULL, salary VARCHAR(80) DEFAULT NULL, contact_person VARCHAR(80) DEFAULT NULL, contact_email VARCHAR(80) DEFAULT NULL, application_date DATE NOT NULL, status VARCHAR(80) NOT NULL, INDEX IDX_288A3A4E4A3353D8 (app_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
